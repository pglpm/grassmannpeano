...
%% Last-Updated: 2019-02-11T21:47:04+0100
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
\newcommand*{\yC}{C}
\newcommand*{\yal}{\alpha}
\makeatletter\newcommand*{\dextro}{\mathord{\,\includegraphics[totalheight=\heightof{@}]{screw-sense_posi.png}\,}}\makeatother
\makeatletter\newcommand*{\laevo}{\mathord{\,\includegraphics[totalheight=\heightof{@}]{screw-sense_nega.png}\,}}\makeatother
%%% Custom macros end @@@
...
should be considered; thus, for example, $-2\dextro \equiv 2\laevo$.
