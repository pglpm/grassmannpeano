...
%% Last-Updated: 2019-02-11T22:45:42+0100
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
\newcommand*{\yC}{C}
\newcommand*{\yal}{\alpha}
\newcommand*{\dextro}{\mathord{\,\includegraphics[totalheight=\heightof{O}]{screw-sense_posi2.png}\,}}
\newcommand*{\laevo}{\mathord{\,\includegraphics[totalheight=\heightof{O}]{screw-sense_nega2.png}\,}}
%%% Custom macros end @@@
