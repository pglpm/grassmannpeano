...
%% Last-Updated: 2019-02-10T18:23:14+0100
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Report-no: ***
\newif\ifarxiv
\arxivfalse
...
\mynote{Synopsis:
  ...
  \item Sum of points
  \item Sum of lines and higher-dim objects
...
\mynote{Add discussion on Peano's educational view and on its failure in
  current, overly complicated presentations}
