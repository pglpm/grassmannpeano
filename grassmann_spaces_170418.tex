...
%% Last-Updated: 2019-02-11T20:23:47+0100
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
We usually speak of a right-handed and a left-handed sense, or of
dextrogyre and laevogyre sense.
...
In the latter case the real number is associated with the whole of space,
not to any point in particular. Hence we call space with outer weight and
outer direction a \emph{scalar}.
...
We have seen that each point, line, plane, and space comes in four
varieties: inner-weighted and inner-oriented, outer-weighted and
outer-oriented, inner-weighted and outer-oriented, and outer-weighted and
inner-oriented. We are thus dealing with sixteen different kinds of
geometrical objects. Their visual representation is shown
in figs~\ref{fig:points_lines}--\ref{fig:planes_space}.



We next show how objects in each of these sixteen categories can be
combined together to obtain an object in the same category. The operation
we're going to introduce is a generalization of the calculation of a
barycentre.
