...
%% Last-Updated: 2019-02-12T16:25:31+0100
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
\newcommand*{\ywp}{\widebar{0}}
\newcommand*{\ywl}{\widebar{1}}
\newcommand*{\ywa}{\widebar{2}}
\newcommand*{\ywv}{\widebar{3}}
%%% Custom macros end @@@
...
Let's indicate an $r$-flat with inner weight with $(\widebar{r}, N-r)$ and
an $r$-flat with outer weight with $(r, \widebar{N-r})$: this redundant
