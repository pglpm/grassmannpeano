...
%% Last-Updated: 2019-02-14T11:39:36+0100
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
different from a harmonic series). Note that whereas the reciprocal of a
length, area, or volume is undefined in the absence of a notion of distance
(metric), the harmonic of parallel lengths, parallel areas, and volumes is
a well-defined geometric construction even without a notion of distance,
because it can be computed in term of sums and ratios. For example, if
$\yal$ and $\ybe$ are parallel areas, their harmonic sum is defined in
terms of ratios as
\begin{equation}
